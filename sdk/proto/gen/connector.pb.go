...
type Finding struct {
	...
	Synopsis         string                 `protobuf:"bytes,16,opt,name=synopsis,proto3" json:"synopsis,omitempty"`
	...
	VprScore         float64                `protobuf:"fixed64,19,opt,name=vpr_score,json=vprScore,proto3" json:"vpr_score,omitempty"`
	BidId            []string               `protobuf:"bytes,20,rep,name=bid_id,json=bidId,proto3" json:"bid_id,omitempty"`
	Iava             []string               `protobuf:"bytes,21,rep,name=iava,proto3" json:"iava,omitempty"`
	PublicationDate  *timestamppb.Timestamp `protobuf:"bytes,22,opt,name=publication_date,json=publicationDate,proto3" json:"publication_date,omitempty"`
	ModificationDate *timestamppb.Timestamp `protobuf:"bytes,23,opt,name=modification_date,json=modificationDate,proto3" json:"modification_date,omitempty"`
	Confidence       float64                `protobuf:"fixed64,24,opt,name=confidence,proto3" json:"confidence,omitempty"`
	CeaId            []string               `protobuf:"bytes,25,rep,name=cea_id,json=ceaId,proto3" json:"cea_id,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *Finding) GetSynopsis() string {
	if x != nil {
		return x.Synopsis
	}
	return ""
...
func (x *Finding) GetPorts() []string {
	if x != nil {
		return x.Ports
	}
	return nil
...
func (x *Finding) GetAuthors() []string {
	if x != nil {
		return x.Authors
	}
	return nil
...
func (x *Finding) GetVprScore() float64 {
	if x != nil {
		return x.VprScore
	}
	return 0
...
func (x *Finding) GetBidId() []string {
	if x != nil {
		return x.BidId
	}
	return nil
...
func (x *Finding) GetPublicationDate() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Finding) GetModificationDate() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Finding) GetCeaId() []string {
	if x != nil {
		return x.CeaId
	}
	return nil
...
const file_connector_proto_rawDesc = "" +
	...
	"\x06Cancel\x12!\n" +
	"\fexecution_id\x18\x01 \x01(\tR\vexecutionId\"\x92\x06\n" +
	"\aFinding\x12\x12\n" +
	...
	"\bsynopsis\x18\x10 \x01(\tR\bsynopsis\x12\x14\n" +
	"\x05ports\x18\x11 \x03(\tR\x05ports\x12\x18\n" +
	"\aauthors\x18\x12 \x03(\tR\aauthors\x12\x1b\n" +
	"\tvpr_score\x18\x13 \x01(\x01R\bvprScore\x12\x15\n" +
	"\x06bid_id\x18\x14 \x03(\tR\x05bidId\x12\x12\n" +
	"\x04iava\x18\x15 \x03(\tR\x04iava\x12E\n" +
	"\x10publication_date\x18\x16 \x01(\v2\x1a.google.protobuf.TimestampR\x0fpublicationDate\x12G\n" +
	"\x11modification_date\x18\x17 \x01(\v2\x1a.google.protobuf.TimestampR\x10modificationDate\x12\x1e\n" +
	"\n" +
	"confidence\x18\x18 \x01(\x01R\n" +
	"confidence\x12\x15\n" +
	"\x06cea_id\x18\x19 \x03(\tR\x05ceaId\"\x8a\x01\n" +
	"\x06Result\x12!\n" +
	...
	"\bfindings\x18\x04 \x03(\v2\x12.connector.FindingR\bfindings\"?\n" +
	"\x04Done\x12!\n" +
...
var file_connector_proto_goTypes = []any{
	...
	(*Finding)(nil),               // 4: connector.Finding
	(*Result)(nil),                // 5: connector.Result
...
var file_connector_proto_depIdxs = []int32{
	...
	11, // 2: connector.Finding.timestamp:type_name -> google.protobuf.Timestamp
	11, // 3: connector.Finding.publication_date:type_name -> google.protobuf.Timestamp
	11, // 4: connector.Finding.modification_date:type_name -> google.protobuf.Timestamp
	4,  // 5: connector.Result.findings:type_name -> connector.Finding
	0,  // 6: connector.ConnectorMessage.register:type_name -> connector.Register
	5,  // 7: connector.ConnectorMessage.result:type_name -> connector.Result
	6,  // 8: connector.ConnectorMessage.done:type_name -> connector.Done
	1,  // 9: connector.WorkerMessage.register_ack:type_name -> connector.RegisterAck
	2,  // 10: connector.WorkerMessage.execute:type_name -> connector.ExecuteJob
	3,  // 11: connector.WorkerMessage.cancel:type_name -> connector.Cancel
	7,  // 12: connector.ConnectorService.Connect:input_type -> connector.ConnectorMessage
	8,  // 13: connector.ConnectorService.Connect:output_type -> connector.WorkerMessage
