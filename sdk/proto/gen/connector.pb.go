...
var file_connector_proto_depIdxs = []int32{
	...
	10, // 1: connector.Finding.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 2: connector.Result.findings:type_name -> connector.Finding
	0,  // 3: connector.ConnectorMessage.register:type_name -> connector.Register
	5,  // 4: connector.ConnectorMessage.result:type_name -> connector.Result
